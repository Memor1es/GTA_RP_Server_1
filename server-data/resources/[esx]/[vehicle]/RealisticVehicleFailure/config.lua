...
cfg = {
	...
	degradingFailureThreshold = 100.0,	--800		-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 100.0,	--360		-- Below this value, health cascading failure will set in
	...
	randomTireBurstInterval = 0,		--120		-- Number of minutes (statistically, not precisely) to drive above 22 mph before you get a tire puncture. 0=feature is disabled

	RegularPrice = 300,
	BodyDamagePerMoney = 0.35,
	EngineDamagePerMoney = 0.45,
	ProgressBarTime = 10*1000,
...
repairCfg = {
	...
	Color = { r = 0, g = 255, b = 128, a = 100},
	Type = 1,
	
	mechanics = {
		{name="修車廠", id=446, r=25.0, x=1019.79,  y=-2309.71,  z=29.53},
		{name="修車廠", id=446, r=25.0, x=1019.61,  y=-2316.01,  z=29.53},
		{name="修車廠", id=446, r=25.0, x=1019.26,  y=-2322.06,  z=29.53},
		{name="修車廠", id=446, r=25.0, x=1019.09,  y=-2328.10,  z=29.53},
		{name="修車廠", id=446, r=25.0, x=1018.75,  y=-2334.78,  z=29.53},
		{name="修車廠", id=446, r=25.0, x=2476.35,  y=4076.47,   z=37.12},
		--{name="修車廠", id=446, r=25.0, x=1182.6,   y=2638.27,   z=36.80},
