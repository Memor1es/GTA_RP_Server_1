...
positions = {
    ...
    {{1765.66, 2613.71, 49.00, 0}, {1782.47, 2608.94, 45.56, 0},{0, 0, 0}, "按下 ~INPUT_CONTEXT~ 爬入通風管"},
    {{1782.47, 2608.94, 43.40, 0}, {1765.66, 2613.71, 50.55, 0},{0, 0, 0}, "按下 ~INPUT_CONTEXT~ 爬入通風管"},
}
