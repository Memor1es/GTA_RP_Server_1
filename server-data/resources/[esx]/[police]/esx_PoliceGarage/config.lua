...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			...
			{x = 477.21,  y = -1022.95, z = 28.1},
			{x = 1859.86,  y = 3676.98, z = 33.65},
			{x = -459.57,  y = 6030.55, z = 31.34},
			{x = 537.82,  y = -35.32, z = 70.66},
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			...
			{x = 1852.69,  y = 3671.86, z = 33.77},
			{x = -461.92,  y = 6035.14, z = 31.34},
			{x = 534.11,  y = -36.59, z = 70.65},
			{x = 472.99,  y = -1025.05, z = 28.16}
		}
	}
}
