...
VehicleMenu = function(type)
	...
	function(data, menu)
        ...
        SetVehicleMod(veh, 11, 3, 0, false)
        SetVehicleMod(veh, 12, 2, 0, false)
        SetVehicleMod(veh, 13, 2, 0, false)
        SetVehicleMod(veh, 15, 3, 0, false)
        SetVehicleMod(veh, 16, 4, 0, false)
