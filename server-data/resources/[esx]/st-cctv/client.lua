...
CCTVCamLocations = {
	...
	[4] =  { ['x'] = 1786.52,['y'] = 2570.64,['z'] = 51.80,['h'] = 46.95, ['info'] = ' prisoncell1', ["recent"] = false },
	[5] =  { ['x'] = 1776.02,['y'] = 2599.54,['z'] = 51.55,['h'] = 291.51, ['info'] = ' prisoncell2', ["recent"] = false },
	[6] =  { ['x'] = 1772.82,['y'] = 2570.5,['z'] = 51.80,['h'] = 306.45, ['info'] = ' prisoncell3', ["recent"] = false },
	[7] =  { ['x'] = 1779.47,['y'] = 2589.61,['z'] = 47.90,['h'] = 175.88, ['info'] = ' prisoncell4', ["recent"] = false },
}
...
AddEventHandler("cctv:camera", function(camNumber)
	...
	if inCam then
		...
		if camNumber > 0 and camNumber < #CCTVCamLocations+1 then
			...
			exports['mythic_notify']:SendAlert('error', "這個鏡頭看起來是壞了, 你要不要50收")
		end
	end
end)
