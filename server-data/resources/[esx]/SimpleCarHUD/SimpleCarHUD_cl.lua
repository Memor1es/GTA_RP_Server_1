...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            drawTxt(timeText, 4, locationColorText, 0.43, screenPosX, screenPosY + 0.046)
            drawTxt(timeText2, 1, locationColorText, 0.35, screenPosX + 0.021, screenPosY + 0.046)
            ...
            if pedInVeh and vehicleClass ~= 13 then
                ...
                if ShouldUseMetricMeasurements() then
                    ...
                    drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.72, screenPosX + 0.000, screenPosY + 0.000)
                    drawTxt("公里", 1, speedColorText, 0.53, screenPosX + 0.026, screenPosY + 0.001)
                else
                    -- Get vehicle speed in MPH and draw speedometer
                    local speed = currSpeed*2.23694
                    local speedColor = (speed >= speedLimit) and speedColorOver or speedColorUnder
                    drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.72, screenPosX + 0.000, screenPosY + 0.000)
                    drawTxt("英哩", 1, speedColorText, 0.53, screenPosX + 0.026, screenPosY - 0.003)
                end
...
Citizen.CreateThread(function()
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            timeText2 = ((hour < 12) and "上午" or "下午")
