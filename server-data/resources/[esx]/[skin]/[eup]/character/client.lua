...
AddEventHandler('mpcreator:OpenMenu',function()
	...
	TriggerEvent('esx_accessories:unset','Helmet')
	TriggerEvent('esx_accessories:unset','Ears')
	TriggerEvent('esx_accessories:unset','Glasses')
	TriggerEvent('esx_accessories:unset','Mask')
	freemodePedMenu:Visible(not freemodePedMenu:Visible())
end)
