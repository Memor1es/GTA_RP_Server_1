...
local banks = {
	...
	{name="City Bank", id=108, x=-2962.582, y=482.627, z=15.703},
	{name="City Bank", id=108, x=-112.202, y=6469.295, z=31.626},
	{name="銀行", id=108, x=314.187, y=-278.621, z=54.170},
	{name="銀行", id=108, x=-351.534, y=-49.529, z=49.042},
	{name="皇家銀行", id=106, x=241.727, y=220.706, z=106.286, principal = true},
...
local atms = {
	...
	{name="ATM", id=277, x=299.55, y=-588.96, z=42.29},
}
--================================================================================================
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("按下 ~INPUT_PICKUP~ 來使用 ~y~ATM ~b~")
