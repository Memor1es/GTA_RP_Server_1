...
Config.CustomDistance    = 1.5
Config.Zones = {

	ls1 = {
		Pos   = { x = 1018.20, y = -2340.63, z = 29.51 },
	...
	ls2 = {
		Pos   = { x = 1174.94, y = 2640.08, z = 36.75 },
		Size  = { x = 1.5, y = 1.5, z = 0.5 },
		Color = { r = 204, g = 204, b = 0 },
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {1.395, 3.256, 6.512, 13.953}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
	...
	modArmor = {
		...
		parent = 'upgrades',
		modType = 16,
		price = {6.977, 11.628, 13.00, 15.00, 18.00, 19.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
