...
Config.DoorList = {
	...
	-- To downstairs (double doors)
	{
		...
		{
		objName = 'v_ilev_ph_gendoor005',
		objCoords  = {x = 465.7, y = -989.49, z = 24.91},
		textCoords = {x = 465.7, y = -989.49, z = 24.91},
		authorizedCodes = { '1337'},
		locked = true,
		distance = 2
	},
		...
		{
		objName = 'v_ilev_ph_gendoor005',
		objCoords  = {x = 465.75, y = -990.58, z = 24.91},
		textCoords = {x = 465.75, y = -990.58, z = 24.91},
		authorizedCodes = { 'police' , 'brigada' },
		locked = true,
		distance = 2
	},
	...
	-- Cell 3
	{
		...
		{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 466.22, y = -998.71, z = 24.9149},
		textCoords = {x = 466.22, y = -998.71, z = 24.9149},
		authorizedCodes = { '1337'},
		locked = true
	},
			...
			{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 466.11, y = -1002.35, z = 24.9149},
		textCoords = {x = 466.11, y = -1002.35, z = 24.9149},
		authorizedCodes = { '1337'},
		locked = true
	},
			...
			{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 481.68, y = -988.27, z = 24.9149},
		textCoords = {x = 481.68, y = -988.27, z = 24.9149},
		authorizedCodes = { '1337'},
		locked = true
	},
				...
				{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 481.69, y = -991.66, z = 24.9149},
		textCoords = {x = 481.69, y = -991.66, z = 24.9149},
		authorizedCodes = { '1337'},
		locked = true
	},
