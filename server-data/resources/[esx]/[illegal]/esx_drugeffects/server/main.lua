...
ESX.RegisterUsableItem('mor', function(source)
        
	local _source = source
local xPlayer = ESX.GetPlayerFromId(source)
xPlayer.removeInventoryItem('mor', 1)
TriggerClientEvent('esx_ambulancejob:useItem', source, 'mor')
TriggerClientEvent('esx_status:add', _source, 'drug', 499000)
TriggerClientEvent('esx_drugeffects:onmor', source)
end)
