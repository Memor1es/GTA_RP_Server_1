...
Config.moneyType = 'item' -- 'cash' or 'black' or 'item'
...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(80000,150000), -- the random range of amount of money you will get for robbery this site
		silverreward = math.random(15,20),
		goldreward = math.random(5,10),
		nameofbank = "中央銀行", --Visual Name that will be the site
	...
	["fleeca2"] = {
		...
		silverreward = math.random(15,20),
		goldreward = math.random(5,10),
		reward = math.random(80000,150000),
		nameofbank = "中央銀行 (高速公路分行)",
		lastrobbed = 0,
	...
	--[[["PrincipalBank"] = {
		...
		silverreward = math.random(35,45),
		goldreward = math.random(25,35),
