...
function deleteLastObject(object_end, x, y, z)
    --ESX.Game.GetClosestEntity(ESX.Game.GetObjects(), false, nil, Config.BinsAvailable)
    ESX.Game.DeleteObject(ESX.Game.GetClosestEntity(ESX.Game.GetObjects(), false, {
        x = x,
        y = y,
        z = z
    },object_end))
    --[[ESX.Game.DeleteObject(ESX.Game.GetClosestObject( {
        x = x,
        y = y,
        z = z
    },object_end))--]]
    ...
    Citizen.CreateThread(function()
        ...
        if myJob == "drug" then
            for k,v in pairs(options) do
                for i, Cords in pairs(v.cords) do
                print(k)
                --print(v.cords.x.."  "..v.cords.y.."  "..v.cords.z)
                --local blip = AddBlipForCoord(v.cords.x, v.cords.y, v.cords.z)
                ...
                AddTextComponentString(_U(v.success_item))
