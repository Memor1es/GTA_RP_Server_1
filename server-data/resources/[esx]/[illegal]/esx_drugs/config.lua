...
Config.Drugs = {
	...
	[_U('weed')] = {
		...
		Zones			= {
			...
			Processing 		= {x = 1393.43,	y = 3602.84,	z = 38.94-1.0001,	name = _U('processing', _U('weed')),	sprite = 496,	color = 52, callPolice = false, callPoliceChance = 100},
	...
	[_U('meth')] = {
		...
		Zones 			= {
			...
			Processing 		= {x = -1785.91,	y = 437.38,	z = 128.11-1.0001,	name = _U('processing', _U('meth')),	sprite = 499,	color = 26, callPolice = false, callPoliceChance = 100},
	...
	[_U('opium')] = {
		...
		Zones 			= {
			...
			Processing 		= {x = 98.0, y = -1290.48, z = 29.27-1.001,	name = _U('processing', _U('opium')), sprite = 51, color = 60, callPolice = false, callPoliceChance = 100},
	...
	[_U('coke')] = {
		...
		Zones 			= {
			...
			Processing 		= {x = -170.68,	y = 6172.92,	z = 31.21-1.0001,	name = _U('processing', _U('coke')),	sprite = 478,	color = 40, callPolice = false, callPoliceChance = 100},
