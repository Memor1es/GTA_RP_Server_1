...
Citizen.CreateThread(
    function()
		...
		ESX.TriggerServerCallback("esx_inventoryhud:getFastWeapons",function(cb)
			fastWeapons = cb
		end)
...
Citizen.CreateThread(
    function()
		while true do
            Citizen.Wait(1)
            if IsDisabledControlJustReleased(1, Keys["TAB"]) or IsDisabledControlJustReleased(1, Keys["1"]) then
