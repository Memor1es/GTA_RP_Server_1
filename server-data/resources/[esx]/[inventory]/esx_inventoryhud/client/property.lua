...
function refreshPropertyInventory()
    ESX.TriggerServerCallback(
        "esx_casas:getPropertyInventory",
        function(inventory)
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            TriggerServerEvent("esx_casas:putItem", data.owner, data.item.type, data.item.name, count)
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            TriggerServerEvent("esx_casas:getItem", data.owner, data.item.type, data.item.name, tonumber(data.number))
        end
