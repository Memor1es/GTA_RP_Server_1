...
AddEventHandler("esx_inventoryhud:openStoreInventory", function(data, playerSafe)
    ...
    function(data, cb) 
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            if isPlayerSafe then         
                ...
                TriggerServerEvent("esx_store:putItem", ESX.GetPlayerData().identifier, data.item.type, data.item.name, count)
            end
        end
