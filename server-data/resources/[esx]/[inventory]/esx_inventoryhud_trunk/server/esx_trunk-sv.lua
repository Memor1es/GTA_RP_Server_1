      ...
      if targetItem.limit == -1 or ((targetItem.count + count) <= targetItem.limit) then
        TriggerEvent(
          ...
          function(store)
            ...
            TriggerClientEvent("esx_inventoryhud:refreshTrunkInventory", _source, data, blackMoney, money, items, weapons)
          end
        )
      else
        TriggerClientEvent(
    ...
    if type == "item_account" then
      TriggerEvent(
        ...
        function(store)
          ...
          local blackMoney = store.get(item)
      ...
      if (playerAccountMoney >= count and count > 0) then
        TriggerEvent(
          ...
          function(store)
            ...
            local blackMoney = (store.get(item) or nil)
