...
{   
    ["Body"]      = vector2(0.1910, 0.3051),
    ["Head"]      = vector2(0.3140, 0.2240),
    ["LeftArm"]   = vector2(0.3700, 0.4044),
    ["LeftLeg"]   = vector2(0.3285, 0.5320),
    ["RightArm"]  = vector2(0.1770, 0.4043),
    ["RightLeg"]  = vector2(0.1960, 0.5320),
