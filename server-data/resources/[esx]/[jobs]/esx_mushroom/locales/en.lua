Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = '按下 ~INPUT_CONTEXT~ 來採 ~g~草~s~.',
  ['weed_inventoryfull'] = '你的背包沒有足夠的空間來放 ~g~草~s~.',
  ...
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Mushroom~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Mushroom Field',
  ['blip_weedprocessing'] = 'Mushroom Processing',
