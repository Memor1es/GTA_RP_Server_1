...
Citizen.CreateThread(function()
	while true do
        ...
        if car ~= 0 and (wasInCar or IsCar(car)) then
            ...
            if speedBuffer[2] ~= nil and not beltOn and GetEntitySpeedVector(car, true).y > 1.0
                and speedBuffer[1] > 19.25 and (speedBuffer[2] - speedBuffer[1]) > (speedBuffer[1] * 0.255) then
...
RegisterNetEvent('seatbelt:setSeatbelt')
AddEventHandler('seatbelt:setSeatbelt', function()
...
RegisterNetEvent('seatbelt:setUnseatbelt')
AddEventHandler('seatbelt:setUnseatbelt', function()
    if beltOn == true then
        beltOn = false
        TriggerServerEvent('InteractSound_SV:PlayOnSource', 'unbuckle', 0.9)
