...
-- You can change the header image for the f5 menu here
...
Config.Languages = {
  ['tc'] = {
        ...
        ['rfavorite'] = "重置最愛動作",
        ['prop2info'] = "❓ Prop Emotes 可以被放在最後",
        ['set'] = "Set (",
        ['setboundemote'] = ") 成為你的最愛表情?",
        ['newsetemote'] = "~w~ 現在是你的最愛表情, 按下 ~g~CapsLock~w~ 來使用它.",
        ['cancelemote'] = "取消動作",
        ...
        ['infoupdate'] = "資訊",
        ['infoupdateav'] = "更新資訊",
        ['infoupdateavtext'] = "有1個更新可以使用, 得到最新版本，至 ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "建議?",
        ['suggestionsinfo'] = "'dullpear_dev' on FiveM forums for any feature/emote suggestions! ✉️",
        ['notvaliddance'] = "不是一個合理的舞蹈.",
        ['notvalidemote'] = "不是一個合理的表情動作.",
        ['nocancel'] = "沒有表情動作可以取消.",
        ['maleonly'] = "這個表情只屬於男性, 抱歉!",
        ['emotemenucmd'] = "Do /emotemenu for a menu.",
        ['shareemotes'] = "👫 分享表情動作",
        ['shareemotesinfo'] = "邀請附近玩家來做表情動作",
        ['sharedanceemotes'] = "🕺 分享舞蹈",
        ['notvalidsharedemote'] = "不是合理的可分享的表情動作.",
        ['sentrequestto'] = "發送請求給 ~y~",
        ['nobodyclose'] = "沒有任何人夠 ~r~靠近~w~ .",
        ['doyouwanna'] = "~y~Y~w~ 接受, ~r~L~w~ 拒絕 (~g~",
        ['refuseemote'] = "表情動作拒絕.",
        ['makenearby'] = "讓附近玩家表演",
        ['camera'] = "按下 ~y~G~w~ 來使用相機閃光.",
        ['makeitrain'] = "按下 ~y~G~w~ 來撒鈔票.",
        ['pee'] = "按住 ~y~G~w~ 來小便.",
        ['spraychamp'] = "按住 ~y~G~w~ 來噴香檳",
        ['bound'] = "最愛 ",
        ['to'] = "給",
        ['currentlyboundemotes'] = " 現在的最愛的表情動作:",
        ['notvalidkey'] = "不是一個合理的按鍵.",
        ['keybinds'] = "🔢 按鍵連接",
        ['keybindsinfo'] = "使用"
  },
  ['en'] = {
