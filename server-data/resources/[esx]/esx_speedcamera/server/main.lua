...
RegisterServerEvent('esx_speedcamera:PayBill90Zone')
AddEventHandler('esx_speedcamera:PayBill90Zone', function()
	local xPlayer = ESX.GetPlayerFromId(source)
	
	xPlayer.removeMoney(1000)	
end)

RegisterServerEvent('esx_speedcamera:PayBill140Zone')
AddEventHandler('esx_speedcamera:PayBill140Zone', function()
	local xPlayer = ESX.GetPlayerFromId(source)
