...
RegisterNetEvent('esx_lock_ability:generateLockPick')
AddEventHandler('esx_lock_ability:generateLockPick', function()
    if timer then
    ...
    elseif exports["esx_ability"]:CheckAbilityRange() then
        TriggerEvent("mythic_progressbar:client:progress", {
            ...
            if not status then
                TriggerServerEvent("esx_lock_ability:giveItem",'lockpick',1)
