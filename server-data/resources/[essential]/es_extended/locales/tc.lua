Locales['tc'] = {
  ...
  ['gave_item'] = '您把~y~%sx~s~~b~%s~s~給予了~y~其他市民~s~',
  --['received_item'] = '您收到~y~%sx~s~~b~%s~s~，來自~b~%s~s~',
  ['received_item'] = '您收到~y~%sx~s~~b~%s~s~，來自~b~其他市民~s~',
  --['gave_weapon'] = '您把~b~%s~s~給予了~y~%s~s~',
  ['gave_weapon'] = '您把~b~%s~s~給予了~y~其他市民~s~',
  --['gave_weapon_ammo'] = '您把~o~%sx~s~~b~%s~s~ %s~s~給予了~y~%s~s~',
  ['gave_weapon_ammo'] = '您把~o~%sx~s~~b~%s~s~ %s~s~給予了~y~其他市民~s~',
  --['gave_weapon_withammo'] = '您把~b~%s~s~和~o~%sx~s~ %s~s~給予了~y~%s~s~',
  ['gave_weapon_withammo'] = '您把~b~%s~s~和~o~%sx~s~ %s~s~給予了~y~其他市民~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~已經有~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~沒有那把武器',
  --['received_weapon'] = '您收到了~b~%s~s~，來自~b~%s~s~',
  ['received_weapon'] = '您收到了~b~%s~s~，來自~b~其他市民~s~',
  --['received_weapon_ammo'] = '您收到了~o~%sx~s~ %s~s~(~b~%s~s~)，來自~b~%s~s~',
  ['received_weapon_ammo'] = '您收到了~o~%sx~s~ %s~s~(~b~%s~s~)，來自~b~其他市民~s~',
  --['received_weapon_withammo'] = '您收到了~b~%s~s~和~o~%sx~s~ %s~s~，來自~b~%s~s~',
  ['received_weapon_withammo'] = '您收到了~b~%s~s~和~o~%sx~s~ %s~s~，來自~b~其他市民~s~',
  --['received_weapon_hasalready'] = '~b~%s~s~嘗試给您~y~%s~s~，但您已经有了',
  ['received_weapon_hasalready'] = '~b~其他市民~s~嘗試給您~y~%s~s~，但您已經有了',
  --['received_weapon_noweapon'] = '~b~%s~s~嘗試给您~y~%s~s~子彈，但是您沒有那把武器',
  ['received_weapon_noweapon'] = '~b~其他市民~s~嘗試給您~y~%s~s~子彈，但是您沒有那把武器',
  --['gave_account_money'] = '您將 ~g~$%s~s~ (%s) 给予 ~y~%s~s~',
  ['gave_account_money'] = '您將 ~g~$%s~s~ (%s) 給予 ~y~其他市民~s~',
  --['received_account_money'] = '您收到了~g~$%s~s~ (%s) 来自 ~b~%s~s~',
  ['received_account_money'] = '您收到了~g~$%s~s~ (%s) ，來自~b~其他市民~s~',
  ['amount_invalid'] = '無效的數量',
  ['players_nearby'] = '附近沒有市民',
  ...
  ['command_clearall'] = '清除所有市民的聊天紀錄',
  ['command_clearinventory'] = '清除市民背包',
  ['command_clearloadout'] = '清除市民人物造型',
  ...
  ['command_giveitem'] = '給市民一個物品',
  ['command_giveitem_item'] = '物品名稱',
  ['command_giveitem_count'] = '物品數量',
  ['command_giveweapon'] = '给市民一把武器',
  ['command_giveweapon_weapon'] = '武器名稱',
  ['command_giveweapon_ammo'] = '子彈數量',
  ['command_giveweapon_hasalready'] = '該市民已經擁有了該武器',
  ['command_giveweaponcomponent'] = '給予武器配件',
  ['command_giveweaponcomponent_component'] = '配件名稱',
  ['command_giveweaponcomponent_invalid'] = '無效的武器配件',
  ['command_giveweaponcomponent_hasalready'] = '該市民已經擁有了武器配件',
  ['command_giveweaponcomponent_missingweapon'] = '該市民沒有那把武器',
  ['command_save'] = '保存市民數據至資料庫',
  ['command_saveall'] = '保存所有市民數據至資料庫',
  ['command_setaccountmoney'] = '為市民設置賬戶資金',
  ...
  ['commanderror_invalidplayerid'] = '無效的市民ID',
  ...
  ['weapon_heavysniper_mk2'] = '重型狙擊槍 Mk.II',
