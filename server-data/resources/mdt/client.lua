    ...
    function()
        ...
        while true do
            ...
            if IsControlJustPressed(0, 73) then
                tabEnabled = false -- Toggle tablet visible state
            ...
            if (tabEnabled) then               
                ...
                DisablePlayerFiring(GetPlayerPed(-1), tabEnabled) -- Disable weapon firing
...
RegisterNetEvent('mdt:toggle')
AddEventHandler('mdt:toggle', function()
    tabEnabled = not tabEnabled -- Toggle tablet visible state
    REQUEST_NUI_FOCUS(tabEnabled)
    print("mdt: " .. tostring(tabEnabled)) 
